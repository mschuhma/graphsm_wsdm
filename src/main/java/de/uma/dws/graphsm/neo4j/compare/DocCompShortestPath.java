...
public class DocCompShortestPath {
	
	final static Logger log = LoggerFactory.getLogger(DocCompShortestPath.class);
	...
	public DocCompShortestPath(Neo4jRdfGraph graph, Snippet s1, Snippet s2, Double maxPathLen) {
		this.graph = graph;
		this.s1 = s1;
		this.s2 = s2;
	...
	public DocCompShortestPath(Neo4jRdfGraph graph, Snippet s1, Snippet s2) {
		this.graph = graph;
		this.s1 = s1;
		this.s2 = s2;
	...
	public Double shortestPath() {
		...
		log.info("Similarity measures S{}, S{}: CommonNodes {}, PathCnt {}, MaxTheoPathCnt {}, SumPathLen {}, CacheCnt {}",
				s1.getSnippetId(),
				s2.getSnippetId(), 
				commonNodeCount,
				pathCount, 
